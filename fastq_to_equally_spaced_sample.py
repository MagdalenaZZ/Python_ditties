...
parser = argparse.ArgumentParser(
    description = 'Gets N (default 10) reads equally spaced from input fastq file',
    usage = '%(prog)s <infile> <outfile>')
parser.add_argument('infile', help='Input fastq file')
parser.add_argument('outfile', help='Name of output file')
parser.add_argument('--reads', type=int, help='Number of reads wanted [%(default)s]', default=10, metavar='INT')
