...
epi = ('\
    \n\
	VCF file parser, allowing for custom advanced filtering of VCF files. Have to give input that has both normal and tumour sample in it\n\
    \n\
')
...
for r in myvcf:
    ...
    nrefd = 0
    naltd = 0
    # Switch between D1 and D2 reads
    d0=1
